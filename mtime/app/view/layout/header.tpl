    ...
    <nav class="navbar">
        ...
        <div class="navbar-menu" id="navMenu">
            <div class="navbar-start">
                ...
                <div class="navbar-item has-dropdown is-hoverable">
                    ...
                    <div class="navbar-dropdown ">
                        ...
                        <a href="{{ window.location.origin }}{{ window.location.pathname }}?location={{ item.id }}"
                            class="dropdown-item">
                            {{ item.name }}
                        </a>
                        {% endfor %}
            ...
            <div class="navbar-end">
                <a class="navbar-item is-hidden-desktop-only" href="https://github.com/1391020381/egg-learing/tree/master/mtime"
                    target="_blank">
